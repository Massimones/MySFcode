...
The scripts generate a file 'EFCMP_input.txt' containing the distribution of forces
in a compatible format for the "edcmp_sf.inp" file.

Just cut and paste the content of 'EFCMP_input.txt' in the "EFCMP.inp" files, below 
